...
```
wget -O workspace/activemq-artemis-operator-1.2.0.zip https://github.com/artemiscloud/activemq-artemis-operator/releases/download/1.2.0/activemq-artemis-operator-1.2.0.zip
unzip workspace/activemq-artemis-operator-1.2.0.zip -d workspace/activemq-artemis-operator-1.2.0
rm -rf workspace/activemq-artemis-operator-1.2.0.zip
workspace/activemq-artemis-operator-1.2.0/install_opr.sh
```
